...
test.describe('Electric Charging Stations Sitemap', () => {
  const desc = CHILD_SITEMAP_MAP.get('https://dev.91trucks.com/sitemap/electric-charging-sitemaps/sitemap-electric-charging-stations.xml');
